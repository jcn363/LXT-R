...
| **Total (actual)** | | **179** | **~16,600** | **P0–P10 ✅** |

**Actual breakdown**: 123 source files (~12,500 LOC) + 55 test files (~4,100 LOC) + 1 bench file = 179 files, ~16,600 total LOC across 21 crates (including `ltx-test-utils` and `ltx-app`).
