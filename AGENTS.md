...
- Tests go in each crate's `tests/` dir with golden `.safetensors` files from Python for numerical comparison
- 20 crates, 159 files, ~11,700 LOC (110 source + 49 test files)
